# Encyclopédie de la préparation mentale

*Ouvrage collectif — mental compétition*
...
S’entraîner dur ne suffit pas : le jour J, l’incertitude (workouts inconnus, juges, adversaires, fatigue émotionnelle) demande des **routines** et une gestion émotionnelle préparées à l’avance. Le mental se programme surtout quand le volume physique descend — sinon il vole le temps d’Accumulation.
...
- Remplacer un deload physique par du « mental only » si la fatigue est structurelle.
- Surcharger la semaine de volume avec des protocoles mentaux longs.

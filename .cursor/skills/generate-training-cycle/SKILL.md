...
3. Ancrer calendrier samedi ON/OFF dans l’index macro (Sxx = relatif au meso).
4. Écrire les semaines depuis `prog/_templates/semaine.md` (patterns + warmups + fondements + feedback).
